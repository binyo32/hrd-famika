  ...
  return (
    <div className="overflow-x-auto">
      ...
      <Table>
        <TableHeader>
          <TableRow>
            <SortableTh label="Tanggal" column="date" sort={sort} onSortChange={onSortChange} />
            <SortableTh label="Nama Karyawan" column="name" sort={sort} onSortChange={onSortChange} />
            <SortableTh label="NIK" column="nik" sort={sort} onSortChange={onSortChange} />
        ...
        <TableBody>
          {loading ? (
            ...
            <TableRow>
              <TableCell colSpan={canManage ? 10 : 9} className="text-center py-6 text-muted-foreground">
            ...
            records.map((record) => (
              <TableRow key={record.id}>
                <TableCell>
                  {new Date(record.attendance_date).toLocaleDateString("id-ID", { timeZone: "UTC" })}
                </TableCell>
